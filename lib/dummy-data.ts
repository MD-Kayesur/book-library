...
export const DUMMY_BOOKS: Book[] = [
  ...
  },
  {
    ...
    video: "/Create_a_highly_realistic_cine (1).mp4",
    summary: "Fahrenheit 451 is a dystopian novel by American writer Ray Bradbury, first published in 1953. Often regarded as one of his best works, the novel presents a future American society where books are outlawed and firemen burn any that are found.",
    isLoanedBook: false,
  },
  {
    id: 8,
